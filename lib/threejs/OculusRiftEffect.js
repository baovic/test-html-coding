...
THREE.OculusRiftEffect = function(renderer, options) {
  ...
  this.setHMD = function(v) {
    ...
    renderTarget = new THREE.WebGLRenderTarget(HMD.hResolution * distScale * 1, HMD.vResolution * distScale * 2, RTParams);
  ...
  this.setSize = function(width, height) {
	...
	this.getDistScale = function(){
		return 1.0 / distScale;
	}
