        ...
        <div class="header">
         ...
         <div class="global">
             <div class="container">   
                ...
                <img src="images/img-0.png" class="phone-email">
             </div><!--container  --> 
         </div><!--global  --> 
        </div>
        <!--header-->
            <div class="container"> 
                <img src="images/banner.png" class="banner1234">
                <p class="p-1">まずはお気軽にお問い合わせください。</p>
                <ul class="listEp">
                    <li><a><img src="images/button-email.png"></a></li>
                    <li><a><img src="images/button-phone.png"></a></li>
                </ul>
                <h2 id="div1">こんなことでお困りではないですか？</h2>
                <img src="images/banner-2.png">
                <p class="p-2">お任せください！その課題、GLOBAL MATCH が解決します！</p>
                <h2 id="div2">サービス概要</h2>
                <img src="images/img-text-1.png" class="img-text-1">
                <p class="p-3">
                    貴社に代わって、台湾市場での最適な販路（取引先台湾企業）を探し、貴社商品の提案・PRを行います。<br>貴社の商品に興味のある台湾企業との商談の場を設定いたします。
                </p>
                <img src="images/banner-3.png" class="banner-3">
                <h2 id="div3">GLOBAL MATCHが選ばれる３つ理由</h2>
                <ul class="listtroubled">
                    <li><img src="images/img-1.png"></li>
                    <li><img src="images/img-2.png"></li>
                    <li><img src="images/img-3.png"></li>
                </ul>
                 <h2>お客様の声</h2>
                 <img src="images/img-text-1.png" class="img-text-1">
...
販路を獲得することができました。<br>また、貿易開始後も弊社の台湾担当のように非常に親身になって動いていただき大変感謝しております。</span>
                 ...
                 <img src="images/img-text-4.png" class="img-text-1" style="margin-top:20px;">
                 <div class="ServiceFlow">
                    <img src="images/img-15.png">

                    <div class="ServiceFlowl">
                ...
                <h2 id="div9">返金保証</h2>
                <img src="images/img-text-5.png" class="img-text-1">
                <div class="Money">
                    <div class="moneyl">
                    ...
                    <div class="Moneyr">
                        ...
                        <p class="p-10"><img src="images/img-19.png"></p>
                    </div>
                </div>
                ...
                <form class="contact" method="post" id="submit-form" action="index.php">
                    ...
                    <fieldset class="fieldset2">
                           <input name="global" id="global" type="text" placeholder="例）GLOBAL MATCH" class="input input-global" value=""> 
                           <p id="error" class="error err-global">error</p>
                           <input name="masahiko"  id="masahiko" tyle="text" placeholder="例）黒春　真彦" class="input input-masahiko" value=""> 
                           <p id="error" class="error err-masahiko">error</p>
                           <input name="email" id="email" type="text" placeholder="例）info@global-match.com" class="input input-email" value=""> 
                           <p id="error" class="error err-email">メールアドレスを入力してください</p>
                           <p id="error" class="error err-email-2">メールアドレスの形式が正しくありません</p>
                           <input name="phone" id="phone" type="text" placeholder="例）03-5908-8325" class="input input-phone" value=""> 
                           <p id="error" class="error err-phone">error</p>
                           <textarea class="input-textarea" name="content"  id="content" type="text" placeholder="輸出希望商品の内容などをご記入ください"></textarea>
                           <p id="error" class="error err-content">error</p>
                    </fieldset>
